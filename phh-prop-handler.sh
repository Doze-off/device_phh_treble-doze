...
# Prefer HW codecs
if [ "$1" == "persist.sys.phh.prefer_hw_codecs" ]; then
    if [[ "$prop_value" != "false" && "$prop_value" != "true" ]]; then
        exit 1
    fi
    if [[ "$prop_value" == "true" ]]; then
...
# Prefer SW codecs
if [ "$1" == "persist.sys.phh.prefer_sw_codecs" ]; then
    if [[ "$prop_value" != "false" && "$prop_value" != "true" ]]; then
        exit 1
    fi
    if [[ "$prop_value" == "true" ]]; then
...
# Max compatibility
if [ "$1" == "persist.sys.phh.max_compatibility" ]; then
    if [[ "$prop_value" != "false" && "$prop_value" != "true" ]]; then
        exit 1
    fi
    if [[ "$prop_value" == "true" ]]; then
...
# Fix screen recorder
if [ "$1" == "persist.sys.phh.fix_screen_recorder" ]; then
    if [[ "$prop_value" != "false" && "$prop_value" != "true" ]]; then
        exit 1
    fi
    if [[ "$prop_value" == "true" ]]; then
